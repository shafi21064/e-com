...
Future<Uint8List> generateCertificate(
  ...
  final medail = await rootBundle.loadString('assets/images/pdf_a/medail.svg');
  final swirls = await rootBundle.loadString('assets/images/pdf_a/swirls.svg');
  final swirls1 = await rootBundle.loadString('assets/images/pdf_a/swirls1.svg');
  final swirls2 = await rootBundle.loadString('assets/images/pdf_a/swirls2.svg');
  final swirls3 = await rootBundle.loadString('assets/images/pdf_a/swirls3.svg');
  final garland = await rootBundle.loadString('assets/images/pdf_a/garland.svg');
