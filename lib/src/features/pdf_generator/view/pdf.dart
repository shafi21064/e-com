...
class PdfGenerate extends StatefulWidget {
  const PdfGenerate({super.key});

  @override
  PdfGenerateState createState() {
    return PdfGenerateState();
  }
}

class PdfGenerateState extends State<PdfGenerate> with SingleTickerProviderStateMixin {
  int _tab = 0;
